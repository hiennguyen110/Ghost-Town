...
var DayTableMixin = /** @class */ (function (_super) {
    ...
    DayTableMixin.prototype.renderHeadDateCellHtml = function (date, colspan, otherAttrs) {
        ...
        if (typeof t.opt('columnHeaderHtml') === 'function') {
            ...
            innerHtml = util_1Escape(t.opt('columnHeaderText')(date));
        }
        else {
            innerHtml = util_1Escape(date.format(t.colHeadFormat));
        }
...
var DayGrid = /** @class */ (function (_super) {
    ...
    DayGrid.prototype.renderGrid = function () {
        ...
        if (this.headContainerEl) {
            this.headContainerEl(this.renderHeadHtml());
        }
...
var BasicView = /** @class */ (function (_super) {
    ...
    BasicView.prototype.renderSkeleton = function () {
        ...
        var dayGridEl;
        this.el.addClass('fc-basic-view')(this.renderSkeletonHtml());
        ...
        SubClass.prototype.renderHeadIntroHtml = function () {
            ...
            if (this.colWeekNumbersVisible) {
                return '' +
                    ...
                    util_1Escape(this.opt('weekNumberTitle')) +
                    '</span>' +
                    '</th>';
            }
            return '';
...
var DateComponent = /** @class */ (function (_super) {
    ...
    DateComponent.prototype.buildGotoAnchorHtml = function (gotoOptions, attrs, innerHtml) {
        ...
        if (!forceOff && this.opt('navLinks')) {
            return '<a' + attrs +
                ' data-goto="' + util_1Escape(JSON.stringify(finalOptions)) + '">' +
                innerHtml +
                '</a>';
        }
        else {
    ...
    DateComponent.prototype.getAllDayHtml = function () {
        return this.opt('allDayHtml') || util_1Escape(this.opt('allDayText'));
    };
...
var AgendaView = /** @class */ (function (_super) {
    ...
    AgendaView.prototype.renderSkeleton = function () {
        var timeGridWrapEl;
        var timeGridEl;
        this.el.addClass('fc-agenda-view')(this.renderSkeletonHtml());
        this.scroller.render();
    ...
    renderHeadIntroHtml: function () {
        ...
        if (this.opt('weekNumbers')) {
            ...
            return '' +
                ...
                view.buildGotoAnchorHtml(// aside from link, important for matchCellWidths
                { date: weekStart, type: 'week', forceOff: this.colCnt > 1 }, util_1Escape(weekText) // inner HTML
                ) +
                '</th>';
        }
        else {
...
var TimeGrid = /** @class */ (function (_super) {
    ...
    TimeGrid.prototype.unrenderDates = function () {
        // this.unrenderSlats(); // don't need this because repeated () calls clear
        this.unrenderColumns();
    };
    TimeGrid.prototype.renderSkeleton = function () {
        var theme = this.view.calendar.theme;
        this.el('<div class="fc-bg"></div>' +
                ...
                '<td class="fc-axis fc-time ' + theme.getClass('widgetContent') + '" ' + view.axisStyleAttr() + '>' +
                    (isLabeled ?
                        '<span>' + // for matchCellWidths
                            util_1Escape(slotDate.format(this.labelFormat)) +
                            '</span>' :
                        '') +
                    '</td>';
            html +=
    ...
    TimeGrid.prototype.renderColumns = function () {
        ...
        this.el.find('> .fc-bg')('<table class="' + theme.getClass('tableGrid') + '">' +
...
var TimeGridEventRenderer = /** @class */ (function (_super) {
    ...
    TimeGridEventRenderer.prototype.fgSegHtml = function (seg, disableResizing) {
        ...
        return '<a class="' + classes.join(' ') + '"' +
            (eventDef.url ?
                ' href="' + util_1Escape(eventDef.url) + '"' :
                '') +
            (skinCss ?
                ' style="' + skinCss + '"' :
                '') +
            ...
            (timeText ?
                '<div class="fc-time"' +
                    ' data-start="' + util_1Escape(startTimeText) + '"' +
                    ' data-full="' + util_1Escape(fullTimeText) + '"' +
                    '>' +
                    '<span>' + util_1Escape(timeText) + '</span>' +
                    '</div>' :
                '') +
            (eventDef.title ?
                '<div class="fc-title">' +
                    util_1Escape(eventDef.title) +
                    '</div>' :
                '') +
            '</div>' +
            '<div class="fc-bg"/>' +
...
var DayGridEventRenderer = /** @class */ (function (_super) {
    ...
    DayGridEventRenderer.prototype.fgSegHtml = function (seg, disableResizing) {
        ...
        if (seg.isStart) {
            timeText = this.getTimeText(seg.footprint);
            if (timeText) {
                timeHtml = '<span class="fc-time">' + util_1Escape(timeText) + '</span>';
            }
        }
        titleHtml =
            '<span class="fc-title">' +
                (util_1Escape(eventDef.title || '') || '&nbsp;') + // we always want one line of height
                '</span>';
        return '<a class="' + classes.join(' ') + '"' +
            (eventDef.url ?
                ' href="' + util_1Escape(eventDef.url) + '"' :
...
var ListView = /** @class */ (function (_super) {
    ...
    ListView.prototype.renderEmptyMessage = function () {
        this.contentEl('<div class="fc-list-empty-wrap2">' + // TODO: try less wraps
            '<div class="fc-list-empty-wrap1">' +
            '<div class="fc-list-empty">' +
            util_1Escape(this.opt('noEventsMessage')) +
            '</div>' +
            '</div>' +
            '</div>');
    };
    ...
    ListView.prototype.dayHeaderHtml = function (dayDate) {
        ...
        return '<tr class="fc-list-heading" data-date="' + dayDate.format('YYYY-MM-DD') + '">' +
            ...
            (mainFormat ?
                this.buildGotoAnchorHtml(dayDate, { 'class': 'fc-list-heading-main' }, util_1Escape(dayDate.format(mainFormat)) // inner HTML
                ) :
                '') +
            (altFormat ?
                this.buildGotoAnchorHtml(dayDate, { 'class': 'fc-list-heading-alt' }, util_1Escape(dayDate.format(altFormat)) // inner HTML
                ) :
                '') +
            '</td>' +
            '</tr>';
    ...
    ListEventRenderer.prototype.fgSegHtml = function (seg) {
        ...
        if (componentFootprint.isAllDay) {
            ...
            if (seg.isStart || seg.isEnd) { // outer segment that probably lasts part of the day
                timeHtml = util_1Escape(this._getTimeText(calendar.msToMoment(seg.startMs), calendar.msToMoment(seg.endMs), componentFootprint.isAllDay));
            }
            ...
            // Display the normal time text for the *event's* times
            timeHtml = util_1Escape(this.getTimeText(eventFootprint));
        }
        if (url) {
                ...
                $.each(buttonGroupStr.split(','), function (j, buttonName) {
                    ...
                    if (buttonName === 'title') {
                        ...
                        if (buttonClick) {
                            ...
                            if (buttonText) {
                                buttonInnerHtml = util_1Escape(buttonText);
                                buttonAriaAttr = '';
                            }
                            else if (buttonIcon) {
